...
def lotus_2D_cell_pow_exp(filename: str, filename2: str, initial,iteration, corerows, corecols,nrows, ncols, nlayers,assembly_row, assembly_col):
    """
    ...
    if (initial == 'first_iteration_constant_feedback'):
       ...
       path = 'outputs/LOTUS_2Dassemblycelllevel_iteration'+str(iteration-1)    
    os.chdir(path)
