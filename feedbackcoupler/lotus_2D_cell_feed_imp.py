...
from hdf5_cell_converter import hdf5_cell_converter

def lotus_2D_cell_feed_imp(filename2: str,iteration,nrows,ncols,nlayers,ngroups,nmaterials,materials_libraries,materials_list, burnable_absorbers):
    ...
    saving in h5 format
    """  
    hdf5_cell_converter(iteration,materials_list,fission_spectrum_material, fission_xsections_interp_material, nu_fission_xsections_interp_material, corrected_scattering_xsections_interp_material, transport_xsections_interp_material, nmaterials, ngroups, nrows, ncols, nlayers)
