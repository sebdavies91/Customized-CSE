...
def hdf5_cell_converter(iteration, materials_list,fission_spectrum_material, fission_xsections_interp_material, nu_fission_xsections_interp_material, corrected_scattering_xsections_interp_material, transport_xsections_interp_material, nmaterials, ngroups, nrows, ncols, nlayers):
    """
