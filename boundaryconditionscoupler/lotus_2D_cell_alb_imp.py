...
def lotus_2D_cell_alb_imp(filename: str, filename2: str,corerows, corecols, nlayers, nsides, ngroups, assembly_row, assembly_col):
    """
    ...
    for k in range(0,nlayers):
        ...
        os.chdir("..")
        os.chdir("..")
        path = 'outputs/LOTUS_2Dassemblycelllevel_iteration0'
        os.chdir(path)
        path2 = 'node'+str(k+1)
        os.chdir(path2)        
        filename4=filename
